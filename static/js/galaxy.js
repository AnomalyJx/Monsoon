...
html {
    cursor: url("data:image/svg+xml,%3Csvg height='6' width='6' viewBox='0 0 8 8' xmlns='http://www.w3.org/2000/svg'%3E%3Ccircle cx='4' cy='4' fill='rgb(255, 165, 0)' r='4'/%3E%3C/svg%3E") 3 3, auto;
}
...
.planet:after {
    ...
    top: -4px;
    left: -4px;
    border-color: hsl(143, 100%, 50%) transparent transparent transparent;
    border-radius: 50%;
    z-index: -8;
    content: "";
}
